...
class GUI2MainWindow(QWidget):
    ...
    def __init__(self):
        ...
        self.firstButton1.setStyleSheet("QPushButton{font-family:'宋体';font-size:48px;color:rgb(0,0,0,255);}\QPushButton{background-color:rgb(201,120,12)}\ QPushButton:hover{background-color:rgb(50, 170, 200)}")
        ...
        self.secondButton1.setStyleSheet(
            "QPushButton{font-family:'宋体';font-size:48px;color:rgb(0,0,0,255);}\QPushButton{background-color:rgb(201,120,12)}"
