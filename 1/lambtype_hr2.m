...
dir0='.';
fname1='lamb_index_BTH_2016hr.txt';
fname2='lamb_index_BTH_2017hr.txt';
fname3='lamb_index_BTH_2018hr.txt';
fname4='lamb_index_BTH_2019hr.txt';
...
set(gca,'Fontsize',14);
strg=strcat('print -dpng lamb_type_27hr_stacked.png');
strg1=[strg];
eval(strg1)
...
set(gca,'Fontsize',14);
strg=strcat('print -dpng lamb_type_27hr.png');
strg1=[strg];
eval(strg1)
...
ylabel({'\fontsize{15} Frequency of Occurence (%)'});
set(gca,'Fontsize',14);
strg=strcat('print -dpng lamb_type_11hr.png');
strg1=[strg];
eval(strg1)
