...
dir0='.';
fname1='lamb_index_BTH_2016hr_MAM.txt';
fname2='lamb_index_BTH_2017hr_MAM.txt';
fname3='lamb_index_BTH_2018hr_MAM.txt';
fname4='lamb_index_BTH_2019hr_MAM.txt';
...
set(gca,'Fontsize',14);
strg=strcat('print -dpng lamb_type_27hr_stacked_MAM.png');
strg1=[strg];
eval(strg1)
...
set(gca,'Fontsize',14);
strg=strcat('print -dpng lamb_type_27hr_MAM.png');
strg1=[strg];
eval(strg1)
...
ylabel({'\fontsize{15} Frequency of Occurence (%)'});
set(gca,'Fontsize',14);
strg=strcat('print -dpng lamb_type_11hr_MAM.png');
strg1=[strg];
eval(strg1)
