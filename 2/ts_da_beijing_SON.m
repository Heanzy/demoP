...
clc;clear;close all
dir0='.';
fname1='ts_2016da_beijing_SON.txt';
fname2='ts_2017da_beijing_SON.txt';
fname3='ts_2018da_beijing_SON.txt';
fname4='ts_2019da_beijing_SON.txt';
...
strg=strcat('print -dpng da_beijing_2016_2017_2018_2019_SON.png');
strg1=[strg];
eval(strg1)
